 ...
 * </p>
 * <ul>
 *   <li>{@link BPMNagentic.impl.ConnectingObjectImpl#getFrom <em>From</em>}</li>
 *   <li>{@link BPMNagentic.impl.ConnectingObjectImpl#getTo <em>To</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConnectingObjectImpl extends BPMNElementImpl implements ConnectingObject {
	...
	protected EClass eStaticClass() {
		return BPMNagenticPackage.Literals.CONNECTING_OBJECT;
	}
		...
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMNagenticPackage.CONNECTING_OBJECT__FROM, oldFrom, from));
			}
		}
		return from;
	}
	...
	public void setFrom(FlowObject newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNagenticPackage.CONNECTING_OBJECT__FROM, oldFrom, from));
	}
	...
	public FlowObject getTo() {
		if (to != null && to.eIsProxy()) {
			...
			if (to != oldTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BPMNagenticPackage.CONNECTING_OBJECT__TO, oldTo, to));
			}
		}
		return to;
	}
	...
	public void setTo(FlowObject newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BPMNagenticPackage.CONNECTING_OBJECT__TO, oldTo, to));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BPMNagenticPackage.CONNECTING_OBJECT__FROM:
				if (resolve) return getFrom();
				return basicGetFrom();
			case BPMNagenticPackage.CONNECTING_OBJECT__TO:
