 ...
 * </p>
 * <ul>
 *   <li>{@link BPMNagentic.impl.BusinessProcessDiagramImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusinessProcessDiagramImpl extends MinimalEObjectImpl.Container implements BusinessProcessDiagram {
	...
	protected EClass eStaticClass() {
		return BPMNagenticPackage.Literals.BUSINESS_PROCESS_DIAGRAM;
	}
	...
	public EList<BPMNElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<BPMNElement>(BPMNElement.class, this, BPMNagenticPackage.BUSINESS_PROCESS_DIAGRAM__ELEMENTS);
		}
		return elements;
	}
