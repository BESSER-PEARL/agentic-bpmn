 ...
 * </p>
 * <ul>
 *   <li>{@link BPMNagentic.impl.GroupImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupImpl extends ArtifactImpl implements Group {
	...
	protected EClass eStaticClass() {
		return BPMNagenticPackage.Literals.GROUP;
	}
	...
	public EList<BPMNElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<BPMNElement>(BPMNElement.class, this, BPMNagenticPackage.GROUP__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNagenticPackage.GROUP__ELEMENTS:
