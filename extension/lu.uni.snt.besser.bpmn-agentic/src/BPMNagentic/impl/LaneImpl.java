 ...
 * </p>
 * <ul>
 *   <li>{@link BPMNagentic.impl.LaneImpl#getFlowObjects <em>Flow Objects</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LaneImpl extends SwimlaneImpl implements Lane {
	...
	protected EClass eStaticClass() {
		return BPMNagenticPackage.Literals.LANE;
	}
	...
	public EList<FlowObject> getFlowObjects() {
		if (flowObjects == null) {
			flowObjects = new EObjectContainmentEList<FlowObject>(FlowObject.class, this, BPMNagenticPackage.LANE__FLOW_OBJECTS);
		}
		return flowObjects;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BPMNagenticPackage.LANE__FLOW_OBJECTS:
