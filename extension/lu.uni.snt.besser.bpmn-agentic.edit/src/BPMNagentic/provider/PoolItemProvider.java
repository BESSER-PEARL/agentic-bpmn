...
/**
 * This is the item provider adapter for a {@link BPMNagentic.Pool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PoolItemProvider extends SwimlaneItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BPMNagenticPackage.Literals.POOL__LANES);
			childrenFeatures.add(BPMNagenticPackage.Literals.POOL__AGENTIC_LANES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BPMNagenticPackage.Literals.POOL__LANES,
				 BPMNagenticFactory.eINSTANCE.createLane()));

		newChildDescriptors.add
			(createChildParameter
				(BPMNagenticPackage.Literals.POOL__AGENTIC_LANES,
